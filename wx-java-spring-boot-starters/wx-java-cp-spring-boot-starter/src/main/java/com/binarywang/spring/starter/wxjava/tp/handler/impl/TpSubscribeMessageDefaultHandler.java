...
import com.binarywang.spring.starter.wxjava.tp.handler.TpSubscribeMessageHandler;
 ...
 * @author falcon
 */
public class TpSubscribeMessageDefaultHandler implements TpSubscribeMessageHandler {
    @Override
